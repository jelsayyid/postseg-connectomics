...
\begin{itemize}
  ...
  \item A ground-truth skeleton dataset (\texttt{XPRESS\_training\_skels.npz}):
        ...
        ground-truth references for proofreading.
...
skeleton nodes at either end of the trajectory define a ground-truth merge pair.
A pipeline \emph{covers} a pair if it generates at least one candidate connecting
...
a shift toward human-in-the-loop systems~\cite{dorkenwald2025cave} where
